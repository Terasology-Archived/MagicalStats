...
/**
 * This event is sent to an entity when there's a change in its wisdom attribute.
 */
public class OnWisdomChangedEvent implements Event {
    /** A reference to the entity who caused the wisdom attribute change. */
     ...
     */
    public OnWisdomChangedEvent(EntityRef instigator, EntityRef character) {
     ...
     */
    public OnWisdomChangedEvent(EntityRef instigator, EntityRef character, int originalValue, int newValue) {
        this.instigator = instigator;
        this.character = character;
